...
template<class NumericT, typename SizeT, typename DistanceT>
vector_base<NumericT, SizeT, DistanceT>::vector_base(viennacl::backend::mem_handle & h,
	size_type vec_size, size_type vec_start, size_type vec_stride, size_type internal_size)
	: size_(vec_size), start_(vec_start), stride_(vec_stride), internal_size_(internal_size), elements_(h) {}
